        ...
        <Card className="backdrop-blur-sm bg-white/80 border-0 shadow-2xl">
          ...
          <CardContent className="space-y-6">
            <form className="space-y-4" onSubmit={submit}>
              ...
              <Button 
                className="w-full h-12 bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg" 
                disabled={loading}
              >
                {loading ? (
            ...
            >
              <svg className="mr-3 h-5 w-5" viewBox="0 0 24 24">
                ...
                />
                <path
                  d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.53 1.18 4.93l2.85-2.22.81-.62z"
                  fill="#FBBC05"
                />
                <path
